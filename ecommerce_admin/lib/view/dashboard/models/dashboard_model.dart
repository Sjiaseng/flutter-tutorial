...
const List<DashboardModel>dashboardModelList = [
  DashboardModel(title: 'Add Product', iconData: Icons.playlist_add, routeName: AddProductPage.routeName),
  DashboardModel(title: 'View Product', iconData: Icons.card_giftcard, routeName: ViewProductPage.routeName),
  DashboardModel(title: 'Categories', iconData: Icons.list, routeName: CategoryPage.routeName),
  DashboardModel(title: 'Orders', iconData: Icons.shopping_cart, routeName: OrderPage.routeName),
  ...
  DashboardModel(title: 'Report', iconData: Icons.analytics, routeName: ReportPage.routeName),
