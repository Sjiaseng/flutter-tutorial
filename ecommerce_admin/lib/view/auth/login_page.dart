...
class _LoginPageState extends State<LoginPage> {
        ...
        child: ListView(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(
                'Login',
                style: const TextStyle().regular.copyWith(color: context.theme.colorScheme.onPrimary),
              ),
            ),
            const SizedBox(
              height: Dimensions.paddingMedium,
  ...
  void _authenticate() async {
    if (_formKey.currentState!.validate()) {
      ...
      const email = 'yihenfoong@gmail.com';
      ...
      try {
        ...
        EasyLoading.dismiss();
        setState(() {
          _errMsg = 'An error occurred. Please try again.';
        });
      }
    }
  }
